...
#define _DIST_MIN 50 // minimum distance to be measured (unit: mm)
...
float USS_measure(int TRIG, int ECHO)
{
  ...
  if(reading < dist_min) reading = dist_min; // return 0 when out of range.
  if(reading > dist_max) reading = dist_max;
  return reading;
}
